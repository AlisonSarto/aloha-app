...
@section('content')
    ...
    <div class="mb-6 flex items-start justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Gerencie os usuários com acesso ao sistema.</p>
        </div>
        <a href="{{ route('admin.users.create') }}"
            ...
            <i class="fas fa-plus text-xs"></i> Criar Usuário
        </a>
    </div>
    ...
    <div class="mb-5 rounded-xl bg-white shadow-sm ring-1 ring-black/5 px-4 py-3 overflow-hidden overflow-x-auto">
        ...
        <table class="min-w-full divide-y divide-gray-100">
            <thead>
                <tr class="bg-green-50">
                    ...
                    <th class="hidden sm:table-cell px-5 py-3.5 text-left text-xs font-semibold text-green-800 uppercase tracking-wide">Email</th>
            ...
            <tbody class="divide-y divide-gray-50">
                @forelse ($users as $user)
                    <tr class="hover:bg-green-50/40 transition-colors">
                        ...
                        <td class="hidden sm:table-cell px-5 py-4 text-sm text-gray-600">{{ $user->email }}</td>
                        <td class="px-5 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-5 py-14 text-center">
                            <i class="fas fa-user-shield text-4xl text-gray-200 block mb-3"></i>
                            <span class="text-sm text-gray-400">Nenhum usuário encontrado.</span>
                        </td>
                    </tr>
                @endforelse
            </tbody>
